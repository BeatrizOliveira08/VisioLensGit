...
alter table tipo_de_sessao change observações_tip_ses observacoes_tip_ses varchar(200);
...
alter table pacote change dimensões_pac dimensoes_pac varchar(200);
